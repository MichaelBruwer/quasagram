<template>
  <q-page class="constrain-more q-pa-md">
   ...
   <div class="text-center q-pa-md ">
     <q-btn round color="grey-10" icon="eva-camera" size="lg" @click="captureImage" v-if="hasCameraSupport" :disable="imageCaptured"/>
     ...
     <div class="row justify-center q-ma-md">
        <q-input v-model="post.location" :loading='locationLoading' label="Location"  class="col col-sm-6" dense>
          <template v-slot:append> 
            <q-btn @click="getLocation" v-if="!locationLoading " round dense flat icon="eva-navigation-2-outline"/>
          </template>
          </q-input>
     </div>
